...
- **Dado** que existen OV en firme (no efectuadas) por 50 unidades del producto X
- **Cuando** consulto su demanda calificada
- **Entonces** el sistema muestra 50 unidades más cualquier pico calificado detectado

### CA-004: Umbral de pico configurable

- **Dado** que la zona roja del producto X es 100 unidades y el umbral de pico es 50%
...
- **Entonces** el flujo neto se actualiza inmediatamente restando las unidades de la OV
...
- **Cuando** el sistema calcula el flujo neto
- **Entonces** Flujo Neto = -30 (negativo) indicando deficit severo

### Escenario: Modificar umbral de pico

- **Dado** que el umbral de pico está en 50% de zona roja
- **Cuando** lo modifico a 75%
- **Entonces** el sistema recalcula qué OV califican como picos
...
> Historia de usuario HU-010 completada.
