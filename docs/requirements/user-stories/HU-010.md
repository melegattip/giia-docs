...
- **Dado** que existen OV en firme (no efectuadas) por N unidades del producto X para el dia de hoy y en el pasado vencido
- **Cuando** consulto su demanda calificada
- **Entonces** el sistema muestra N unidades más cualquier pico calificado detectado en el horizonte de picos configurado
...
- **Cuando** se registra dentro del horizonte de picos una OV por 60 unidades (>50 = 50% de 100)
