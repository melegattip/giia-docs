...
- **Entonces** el sistema usa este valor para todas las conversiones
...
- **Entonces** el sistema consolida todo en la moneda base usando el tipo de cambio actual
...
### Escenario: Tipo de cambio desactualizado

- **Dado** que el tipo de cambio no se actualiza hace 7 días
- **Cuando** accedo a KPIs
- **Entonces** el sistema muestra advertencia "Tipo de cambio desactualizado (última actualización: hace X días)"
...
> Historia de usuario HU-020 completada.
