...
- **Entonces** el sistema muestra advertencia y no permite el registro, ya que es stock fisico del sistema debe ser fiel a la realidad
...
- Los ajustes negativos no pueden resultar en inventario negativo
