...
- **Entonces** el sistema crea los 500 productos en una sola operación
...
- **Entonces** puedo: importar solo los válidos, corregir el archivo y reintentar, o cancelar
...
> Historia de usuario HU-018 completada.
