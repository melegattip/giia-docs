...
- **Dado** que quiero aumentar una zona de buffer en un 20%
- **Cuando** aplico FAZ=1.2 al producto X en los proximos N dias que elijo a la zona que quiero aumentar
- **Entonces** el sistema multiplica la zona que quiero aumentar por 1.2
...
- **Entonces** el sistema lo mantiene activo indefinidamente hasta que lo desactive manualmente, pero el producto aparece con un icono de advertencia indicando que tiene un ajuste sin fecha de fin.
