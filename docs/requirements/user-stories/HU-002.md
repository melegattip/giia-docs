...
- **Entonces** el sistema muestra una advertencia indicando que debe reasignar los productos antes de eliminar
...
- **Cuando** edito "Cables" y cambio su padre a "Accesorios"
- **Entonces** la categoría se mueve al nuevo padre manteniendo sus productos asociados
