...
- **Dado** que un producto pasa de zona verde a zona amarilla o de zona amarilla a zona roja
- **Cuando** el sistema detecta el cambio
- **Entonces** genera una alerta visible en el centro de notificaciones con prioridad media o alta respectivamente
...
- **Entonces** el sistema calcula el umbral según el LT del proveedor
